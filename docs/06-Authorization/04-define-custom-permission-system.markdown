# Define Custom Permission System [](id=define-custom-permission-system)
...
public interface HyperIoTPermissionManager {
    Logger log = LoggerFactory.getLogger(HyperIoTPermissionManager.class.getName());
