...
/**
 * @author Aristide Cittadino Interface component for EthereumConnectorApi. This interface
 * defines methods for additional operations.
 */
public interface EthereumBlockChainRepository extends HyperIoTBaseRepository<EthereumBlockChain> {
    /**
     * @param contractClass
